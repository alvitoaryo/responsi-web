<?php
  ...
  if(isset($_GET['kategori']))
      {
        if($_GET['kategori'] == "bangunan") {
          $kategori='Bangunan';
        }else if($_GET['kategori'] == "kendaraan") {
          $kategori='Kendaraan';
        }else if($_GET['kategori'] == "alattuliskantor"){
          $kategori='Alat Tulis Kantor';
        }else if($_GET['kategori'] == "elektronik"){
          $kategori='Elektronik';
        }
      }
?>
<html> 
  ...
  <body>
    ...
    <table class="table table-bordered">
          <thead>
            <tr class="text-white" style="background-color: #6610f2;">
          ...
          <?php  
            ...
            $no = 1;
            $totalinv=0;
            $query= mysqli_query($konek,"SELECT * from inventaris where kategori='$kategori'"); 
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-sm" style="background-color: #d63384; width: 60px;" href=hapus.php?kode_barang=<?php echo $data['kode_barang'];?>>Hapus</a>
              </td>
            <?php }
            ?>
